<template>
  <div>
    ...
    <div>
      ...
      <div>
        <b-form-group label="Maakond:" label-for="county" label-cols-sm="4" label-cols-lg="3">
          <b-form-input id="county"></b-form-input>
        </b-form-group>
        ...
        <b-form-group
          ...
          label-cols-lg="3"
        >
          <b-form-input id="house-number" type="number"></b-form-input>
        </b-form-group>
      </div>
    </div>
    <div>
      ...
      <b-form-group
        ...
        label-cols-lg="3"
      >
        <b-form-select v-model="selected" id="select" :options="options"></b-form-select>
      </b-form-group>
      <b-form-group
      ...
      <b-form-group
        ...
        label-cols-lg="3"
      >
        <b-form-input id="pet-count" type="number"></b-form-input>
      </b-form-group>
      <b-form-group
        v-if="selected == 'pet' || selected == 'both'"
        label="Loomade liik"
        ...
        label-cols-lg="3"
      >
        <b-form-select v-model="petSelected" id="pet-type" :options="petTypes"></b-form-select>
      </b-form-group>
    ...
    <div>
      ...
      >Olen läbi lugenud ja nõustun lepingu tingimustega</b-form-checkbox>
      <b-form-group
